    ...
    <div class="link-bar">
        <p class="link-bar-comments">
            <a href="<?php  echo $data['baseurl'];  ?>index.php/comments/<?php echo $v1->id; ?>">
                [<?php echo $v1->nrOfComments; ?>] Kommentarer
            </a>  - Postat av <a href=""><?php echo $v1->author; ?></a> <?php echo $v1->date; ?>
            
        </p>
        <p class="link-rating">
            <a href="?vote=down&id=<?php echo $v1->id; ?>">-</a> [<?php echo $v1->rating; ?>] <a href="?vote=up&id=<?php echo $v1->id; ?>">+</a>
        </p>
