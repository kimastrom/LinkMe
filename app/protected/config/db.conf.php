...
$dbmap['Comment']['belongs_to']['Link'] = array('foreign_key' => 'id');
$dbmap['Comment']['belongs_to']['User'] = array('foreign_key' => 'id'); 

//Link reationship
$dbmap['Link']['has_many']['Comment'] = array('foreign_key' => 'link_id');
$dbmap['Link']['has_many']['Link_rating'] = array('foreign_key' => 'link_id');
$dbmap['Link']['belongs_to']['Category'] = array('foreign_key' => 'id');
$dbmap['Link']['belongs_to']['User'] = array('foreign_key' => 'id');

//Link_rating relationship
$dbmap['Link_rating']['belongs_to']['Link'] = array('foreign_key' => 'id');
$dbmap['Link_rating']['belongs_to']['User'] = array('foreign_key' => 'id');

//User relationship
$dbmap['User']['has_many']['Comment'] = array('foreign_key' => 'author_id');
$dbmap['User']['has_many']['Link_rating'] = array('foreign_key' => 'user_id');
$dbmap['User']['has_many']['Link'] = array('foreign_key' => 'user_id');

//Category relationship
$dbmap['Category']['has_many']['Link'] = array('foreign_key' => 'category_id');

 
$dbconfig['dev'] = array('127.0.0.1', 'bernt', 'root', '', 'mysql', true);
$dbconfig['prod'] = array('127.0.0.1', 'bernt', 'root', '', 'mysql', true);
