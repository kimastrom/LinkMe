...
//Startsida med alla länkar
$route['*']['/'] = array('LinkController', 'showLinks');

//skapa ta bort länkar
$route['*']['/addlink'] = array('LinkController', 'addlink');
$route['*']['/deletelink'] = array('LinkController', 'deletelink');

//sortering av länkar
$route['*']['/s/:sort'] = array('LinkController', 'showLinks');
$route['*']['/c/:category'] = array('LinkController', 'showLinks');
$route['*']['/c/:category/:sort'] = array('LinkController', 'showLinks');

//Singleview
$route['*']['/comments/:id'] = array('LinkController', 'singleView');

//Auth routes
$route['*']['/register'] = array('AuthController', 'register');
